...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Snap = __webpack_require__(3);
	...
	var _bubble = __webpack_require__(6);
	...
	var acceleration = (0, _bezierEasing2.default)(.85, .15, .15, .85);
	    ...
	    _createClass(SvgAnimations, [{
	        ...
	        value: function loadSprite() {
	            ...
	            return new Promise(function (resolve, reject) {
	                _Snap2.default.load('./assets/sprite.svg', function (svg) {
	                    _this.svg = svg;

	                    (0, _Snap2.default)('body').append(svg);
	        ...
	        value: function createCogAnimation() {
	            var canvas = (0, _Snap2.default)(140, 140);
	            ...
	            (0, _Snap2.default)('.js-cog-svg-icon').append(canvas);
	        }
	    }]);
